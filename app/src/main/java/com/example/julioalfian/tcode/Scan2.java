...
public class Scan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent captureIntent = new Intent(Scan2.this, CaptureActivity.class);
        ...
        tvScanResult = (TextView) findViewById(R.id.tv_scanresult2);



        Button btSent = (Button) findViewById(R.id.bt_sent2);
        btSent.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View view){
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(Scan2.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
...
//                String QuickPassword = password;
            ...
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(Scan2.this, "Data Submit Successfully", Toast.LENGTH_LONG).show();
